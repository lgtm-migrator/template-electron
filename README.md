# Welcome to @koromerzhin/template-electron 👋

![Version](https://img.shields.io/badge/version-1.0.0-blue.svg?cacheSeconds=2592000)
![Documentation](https://img.shields.io/badge/documentation-yes-brightgreen.svg)
[![Maintenance](https://img.shields.io/badge/Maintained%3F-yes-green.svg)](https://github.com/koromerzhin/template-electron/graphs/commit-activity)
![Continuous Integration](https://github.com/koromerzhin/template-electron/workflows/Continuous%20Integration/badge.svg?branch=develop)<!-- ALL-CONTRIBUTORS-BADGE:START - Do not remove or modify this section -->
...
Feel free to check [issues page](https://github.com/koromerzhin/template-electron/issues).
You can also take a look at the [contributing guide](
    https://github.com/koromerzhin/template-electron/blob/develop/CONTRIBUTING.md
    ).
...
This project is [MIT](
    https://github.com/koromerzhin/template-electron/blob/develop/LICENSE
    ) licensed.
